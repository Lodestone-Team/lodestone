        ...
        </h2>
        {
          signupData === null ?
            ...
            <>
              ...
              <Button className="mt-6" label="Verify" onClick={handleVerifySignup} />
            </>
        }
      </PlayitggSignupModal>
      {verified === null ? 
          ...
          <div>
            <div className='flex flex-row'> 
              ...
              <IconButton
                ...
                className='ml-2'
              />
              <Label size="small" color={labelColor as LabelColor} className='mt-[6px] ml-2'>
                {runnerStatus}
              </Label>
            </div>
            <h3 className="text-h3 font-medium italic tracking-medium text-white/50">
              { verified === true ?
                ...
                : <>You need to sign up for Playitgg before you can use this. <div className='underline hover:cursor-pointer' onClick={() => setShowSignupModal(true)}>Press here to sign up.</div></>
              }
            </h3>
