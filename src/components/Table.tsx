...
export function Table({rows, columns, className}: CardProps) {
    return (
        <div className={cn("flex h-fit max-h-full w-full flex-col overflow-x-auto bg-gray-875", className)}>
            <div className="flex h-fit min-h-fit w-fit flex-col">
                <div
                    className="flex h-6 min-h-[24px] items-center gap-2.5 self-stretch overflow-x-hidden border-b border-b-fade-700 px-3">
