...
pub struct UserPermission {
    ...
    pub can_access_console: HashSet<String>,
    pub can_access_setting: HashSet<String>,
    pub can_read_resource: HashSet<String>,
    // unsafe permission, owner exclusive unless explicitly granted
    pub can_write_resource: HashSet<String>,
    // unsafe permission, owner exclusive unless explicitly granted
    pub can_access_macro: HashSet<String>,
...
impl UserPermission {
    pub fn new() -> Self {
        UserPermission {
            ...
            can_access_console: HashSet::new(),
            can_access_setting: HashSet::new(),
            can_read_resource: HashSet::new(),
            can_write_resource: HashSet::new(),
            can_access_macro: HashSet::new(),
