...
mod tests {
    ...
    async fn test_get_vanilla_jar_url() {
        ...
        assert_eq!(super::get_vanilla_jar_url("1.8.4").await, Some(("https://piston-data.mojang.com/v1/objects/dd4b5eba1c79500390e0b0f45162fa70d38f8a3d/server.jar".to_string(), Flavour::Vanilla)));
